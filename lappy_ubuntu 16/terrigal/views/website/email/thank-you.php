            ...
            <td>
               <center style="width: 100%;">
                  ...
                  <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#F4FFCD" width="600" class="email-container">
                     ...
                     <!-- 1 Column Text : BEGIN -->
                     <tr>
                     <td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 19px; mso-height-rule: exactly; line-height: 20px; color: #555555;"><strong>You're almost done...<br>
                     </strong><br>
                     Log in using the username and password below and update your Terrigal Business Listing Account. 
                     <br>It's easy — just click the button below.<br>
                     <br>
                     <br>
                     <!-- Button : Begin -->
                     ...
                     <td style="padding: 0px 40px 0px 40px; font-family: sans-serif; font-size: 19px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                        <p>Username: <strong><?php echo @$user_name; ?></strong></p> 
                        <p>Password: <strong><?php echo @$password; ?></strong></p>
                    </td>
                    </tr>
                    <tr>
                     <td style="border-radius: 3px; background: #52c2d3; text-align: center;" class="button-td"><a href="https://www.terrigal.com.au/login" style="background: #52c2d3; border: 15px solid #52c2d3; padding: 0 10px;color: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a"> 
                     <!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->Login<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--> 
                     </a></td>
                     </tr>
                     </table>
                     <!-- Button : END --></td>
