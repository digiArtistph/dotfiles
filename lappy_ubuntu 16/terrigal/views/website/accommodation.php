<!DOCTYPE html>
<html lang="en" data-ng-app="accommodation">
<head>
    <meta charset="utf-8">
    ...
    <title>Accommodation | Terrigal</title>
...
//    var BASE_URL = '<?php //echo base_url(); ?>//';
    ...
    var app = angular.module('accommodation', [
        'ngMap',
        'ezfb',
        'ngRateIt',
        'uiSwitch',
        ...
        'treasure-overlay-spinner']);
    angular.module('accommodation').run(run);
...
<script>
    $(document).ready(function () {
        ...
        $(window).scroll(function () {
            if($(this).scrollTop() > offset) {
                $('.footer-advertise-fixed').fadeIn(0);
            } else {
        ...
        $(window).scroll(function () {
            if (($(this).scrollTop() + $(this).innerHeight()) == $(document).height()) {
                $('.footer-advertise-fixed').fadeOut(0);
                $('.footer-advertise-fixed-small').fadeIn(0);
            } else {
                $('.footer-advertise-fixed-small').fadeOut(0);
            }
        });
    });
</script>
